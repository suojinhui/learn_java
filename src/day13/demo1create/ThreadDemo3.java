...
public class ThreadDemo3 {
    public static void main(String[] args) {
        ...
        Callable<String> c3 = () -> "结束";
        FutureTask<String> f3 = new FutureTask<>(c3); // public FutureTask(Callable<V> callable)
        ...
        try {
            // 如果主线程发现第三个线程还没有执行完毕，会让出CPU，等第三个线程执行完毕后，才会往下执行！
