package stonemaze.src.com.itheima;
...
public class MainFrame extends JFrame {
    // 设置图片位置
    private static final String imagePath = "src/stonemaze/src/image/";
    ...
    private void writeFileScore(int count) {
        try(
                FileWriter fw = new FileWriter("src/stonemaze/src/score.txt");
    ...
    private int readFileScore() {
        try(
                FileReader fr = new FileReader("src/stonemaze/src/score.txt");
